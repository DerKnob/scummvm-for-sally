...
#
# $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-1-1/tools/dist-scummvm.sh $
# $Id: dist-scummvm.sh 30470 2008-01-13 13:24:14Z fingolfin $
