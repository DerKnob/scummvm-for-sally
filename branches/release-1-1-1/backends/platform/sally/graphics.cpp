 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-1-1/backends/platform/sdl/graphics.cpp $
...
#ifdef __SALLY__
SDL_Surface* OSystem_SDL::lockHardwareScreen()
{
	lockMutex(_graphicsMutex);
...
void OSystem_SDL::unlockHardwareScreen()
{
	unlockMutex(_graphicsMutex);
}

int OSystem_SDL::getVideoScaleVactor()
{
	if (!_overlayVisible)
