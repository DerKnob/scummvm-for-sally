 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-1-1/backends/platform/sdl/sdl.h $
 * $Id: sdl.h 48101 2010-02-21 04:04:13Z bluddy $
 *
 */
...
#ifdef __SALLY__
	SDL_Surface* lockHardwareScreen();
	void		 unlockHardwareScreen();
	int			 getVideoScaleVactor();
#endif
