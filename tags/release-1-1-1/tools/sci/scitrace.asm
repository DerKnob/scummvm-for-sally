...
;
; $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-1-1/tools/sci/scitrace.asm $
; $Id: scitrace.asm 48111 2010-02-22 18:06:21Z m_kiewitz $
;
;---------------------------------------------------------------------------
;
; SCITRACE
