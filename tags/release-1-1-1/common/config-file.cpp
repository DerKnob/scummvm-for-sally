 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-1-1/common/config-file.cpp $
 * $Id: config-file.cpp 46746 2009-12-30 14:55:33Z mthreepwood $
 *
 */
